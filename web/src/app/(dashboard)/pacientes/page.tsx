...
const mockPatients = [
    { id: 'P-9842', name: 'Carlos Mendoza', age: 45, phenotype: 'Resistencia a la Insulina', lastVisit: '16/Nov/2026', status: 'Riesgo' },
    { id: 'P-1029', name: 'Ana Silva', age: 34, phenotype: 'Comedor Emocional', lastVisit: '10/Nov/2026', status: 'Estable' },
    { id: 'P-3041', name: 'Luisa Fernanda', age: 52, phenotype: 'Inflamatorio', lastVisit: '05/Nov/2026', status: 'Mejorando' },
];
...
export default function PatientListPage() {
    ...
    const handleCreatePatient = async (e: React.FormEvent) => {
        ...
        // Aquí iría la llamada a Supabase Server Action para insertar en patients_identity
        // await createPatientAction(newPatient);
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between p-6 border-b border-slate-100">
                            ...
                            <Button variant="ghost" size="icon" className="text-slate-400 hover:text-slate-600 rounded-full" onClick={() => setIsModalOpen(false)}>
                                <X className="w-5 h-5" />
                            </Button>
                        </div>
                        ...
                        <form onSubmit={handleCreatePatient} className="p-6">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                                <Button type="button" variant="outline" onClick={() => setIsModalOpen(false)} className="border-slate-300 text-slate-700">
                                    Cancelar
                                </Button>
